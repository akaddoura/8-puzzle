        ...
        with open('output.txt', 'w+') as f:
            ...
            for move in puzzle.goal_board.move_actions:
                ...
                if move == 4:
                    ...
                    '''
                    f.write(f"_____\n")
                    f.write(f"| {str(puzzle.goal_board.values[0])} | {str(puzzle.goal_board.values[1])} |  {str(puzzle.goal_board.values[2])} |\n")
                    f.write(f"-------\n")
                    f.write(f"| {str(puzzle.goal_board.values[3])} | {str(puzzle.goal_board.values[4])} |  {str(puzzle.goal_board.values[5])} |\n")
                    f.write(f"-------\n")
                    f.write(f"| {str(puzzle.goal_board.values[6])} | {str(puzzle.goal_board.values[7])} |  {str(puzzle.goal_board.values[8])} |\n")
                    f.write(f"-------\n")
                    '''
